...
// Cross Module References
	ADVGAMEPROGPROJECT_API UClass* Z_Construct_UClass_ASCharacter_NoRegister();
	...
	ADVGAMEPROGPROJECT_API UFunction* Z_Construct_UFunction_ASCharacter_OnHealthChanged();
...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_ASCharacter_OnHealthChanged()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				{ "ModuleRelativePath", "Public/Character/SCharacter.h" },
			};
#endif
	...
	UClass* Z_Construct_UClass_ASCharacter()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_ASCharacter_OnHealthChanged, "OnHealthChanged" }, // 363203140
			};
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
				{ "HideCategories", "Navigation" },
				{ "IncludePath", "Character/SCharacter.h" },
				{ "ModuleRelativePath", "Public/Character/SCharacter.h" },
			};
#endif
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ASCharacter, 1579078999);
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASCharacter(Z_Construct_UClass_ASCharacter, &ASCharacter::StaticClass, TEXT("/Script/AdvGameProgProject"), TEXT("ASCharacter"), false, nullptr, nullptr, nullptr);
