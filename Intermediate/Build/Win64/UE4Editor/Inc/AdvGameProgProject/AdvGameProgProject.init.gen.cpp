...
void EmptyLinkFunctionForGeneratedCodeAdvGameProgProject_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_AdvGameProgProject()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_AdvGameProgProject_OnHealthChangedSignature__DelegateSignature,
			};
